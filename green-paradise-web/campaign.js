(function (root) {
  ...
  const ARCHIVES = [
    ["目覚め", "起動装置の記録：位置情報は破損。最後の点検欄には、人が入力した文字が残っていた。『地表の調査を再開する』。送り主の名前と日付は読めない。"],
  ...
  const STORY_OBJECTIVES = [
    ["ここはどこなんだろう。まずは、あの街まで行ってみよう。", "家はあるのに、誰もいない。向こうの通りも探してみよう。", "動くものがいる！ でも、近づくと襲ってくる。何者なんだ？", "まだ使えそうな入口だ。中に、この街の手がかりがあるかもしれない。", "あの大きなやつが道をふさいでる。この先を調べるには、乗りこえるしかない！"],
    ["ここまで砂だらけだ。街の続きは、どこへ行ったんだろう。", "砂に埋まった道が続いてる。見失わないように進もう。", "またあの敵だ。この場所にもいるなんて……。", "地下へ続く道がある。地上で見つからないなら、下を探そう。", "洞窟への道をふさいでる！ あそこを通れば、先へ進める。"],
    ["地下なのに明るい。光のある方へ進んでみよう。", "奥に人工の足場がある。誰かがここを使っていたんだ。", "この道、どこまで続いてるんだろう。出口を探さなくちゃ。", "機械の音が近くなった。向こうに建物があるのかな？", "出口が見えた！ でも、大きな敵を越えないと通れない。"],
    ["工場だ。ここなら、この世界で何があったか分かるかもしれない。", "ずっと前に止まったみたいだ。まだ入れる場所を探そう。", "こんな工場の中にも敵がいる。ここを守っているのかな？", "奥へ進む道が残ってる。何も分からないまま、引き返したくない。", "あの先が工場の出口だ。こんなところで止まっていられない！"],
    ["建物が水に囲まれてる。人がいないか、一つずつ確かめよう。", "窓はあるけど、返事がない。隣の建物まで行ってみよう。", "敵ばかりなのに、人の姿はない。みんな、どこへ行ったんだろう。", "まだ確かめていない建物がある。誰か残っていないかな。", "先へ進めば、この場所から出られる。あの敵を越えていこう。"],
    ["こんどは雪だ。足あとが消える前に、道を見つけよう。", "寒くても、建物の中なら探せる。開いている入口はないかな。", "また誰もいない……。でも、調べるのはやめない。", "山の向こうへ道が続いてる。この場所から先へ行けそうだ。", "ここを越えれば山道に出られる。あと少し、がんばろう！"],
    ["谷の向こうに大きな施設がある。あそこを目指そう。", "下は深い谷だ。足場を確かめながら、施設に近づこう。", "近づくほど敵が増えてる。あそこに、何かあるのかな。", "施設までは、あと少し。入口につながる道を探そう。", "あの敵が入口を守ってる。この先に何があるのか、確かめるんだ！"],
    ["研究所みたいだ。こんな場所で、何をしていたんだろう。", "まだ明かりがついてる。動いている部屋があるのかもしれない。", "奥へ行く道だけ残ってる。ここを通ってみよう。", "行き止まりじゃない。上の施設へ続いてる！", "研究所の奥へ進みたい。ここで追い返されるわけにはいかない！"],
    ["高い場所まで来た。ここから、世界の様子を確かめよう。", "遠くも灰色だ。緑がないのは、最初の街だけじゃなかったんだ。", "まだ先へ進める。この世界を、このままにはしたくない。", "いちばん奥の施設が見えた。あそこまで道をつなごう。", "最後の施設への道がふさがれてる。ここを越えて、奥へ行く！"],
    ["ここまで来た。世界の緑を取り戻すために、奥へ進もう。", "大きな音がする。いちばん奥で、何かが動いている。", "この先が中心部だ。怖いけど、引き返せない。", "もうすぐ最後の扉だ。ここまで歩いた道を、無駄にしない。", "ゼロパラダイス。世界の緑を、返してもらう！"],
  ];
  const STORY_DEPARTURES = [
    "崩れた街へ続く道を、グリーンは見つめた。",
    "街道は砂に埋もれ、その先だけがかすかに見える。",
    "地面の裂け目から、洞窟の光がもれていた。",
    "洞窟を抜けると、巨大な工場が姿を現した。",
    "工場の先には、水に囲まれた建物が並んでいた。",
    "雪に閉ざされた道が、山のふもとへ続いている。",
    "谷の向こうに、これまでより大きな施設が見えた。",
    "研究所の入口で、グリーンは胸の明かりを灯した。",
    "雲の間に、観測所へ続く足場が見え隠れしていた。",
    "最後の施設の奥から、重い振動が伝わってくる。",
  ];
  const STORY_ROUTES = [
    "道が開いた！ 街の向こうも探して、緑を取り戻そう。",
    "洞窟へ進めるぞ。地下に何があるか、確かめよう。",
    "出口だ！ あの大きな工場を調べてみよう。",
    "水辺へ続いてる。あっちに人がいないか探そう。",
    "山へ行ける道がある。まだ、調べられる場所はあるんだ。",
    "谷の向こうに施設が見える。次は、あそこだ。",
    "研究所への道が開いた。中に入って確かめよう。",
    "上の観測所へ行ける！ 世界に何が起きたか、確かめたい。",
    "最後の施設へつながった。世界の緑を、取り戻すんだ。",
    "最後の扉へ進もう。もう、逃げない。",
  ];
  function story(stage, trigger) {
    ...
    let lines;
    if (stage.id === 1 && trigger === "start") {
      lines = [
        line("グリーン", "……ここはどこ？ 誰か、いないの？"),
        line("ナレーション", "グリーンが目を開くと、草も花もない大地と、崩れた街が広がっていた。"),
        line("グリーン", "あれ？ ぼくが歩いたところに、草が生えた！ ぼくに、こんな力があるの？"),
        line("グリーン", "この力で、緑を取り戻せるかもしれない。まずはあの街へ行こう。何があったか知りたい！"),
      ];
    } else if (stage.id === 50) {
      lines = trigger === "start" ? [line("ナレーション", "最後の扉の向こうで、ゼロパラダイスが目を開いた。その体の奥には、奪われた緑の光が渦を巻いている。"), line("グリーン", "おまえが、世界の緑を……！ これ以上、奪わせない。みんなの大地へ返すんだ！")]
        : [line("ナレーション", "ゼロパラダイスの鼓動が止まる。ひび割れた体から、数えきれない緑の光があふれ出した。"), line("グリーン", "やった……！ 世界に緑が戻るんだ。さあ、みんな、大地へ帰ろう！")];
    } else if (trigger === "boss") {
      if (!stage.boss) return null;
      lines = [line("ナレーション", `${stage.boss.name}が倒れた。ふさがれていた道の先を、グリーンは見渡した。`), line("グリーン", STORY_ROUTES[stage.region])];
    } else if (trigger === "goal") {
      lines = [line("ナレーション", "大樹に緑の光がともる。グリーンは、自分が歩いてきた道を振り返った。"), line("グリーン", stage.id === 1 ? "本当に、緑が戻った！ この先にも届けよう。それに、街に誰かいないか探さなくちゃ。" : stage.boss ? STORY_ROUTES[stage.region] : STORY_OBJECTIVES[stage.region][Math.min(4, stage.local + 1)])];
    } else {
      lines = [line("ナレーション", STORY_DEPARTURES[stage.region]), line("グリーン", STORY_OBJECTIVES[stage.region][stage.local])];
    }
